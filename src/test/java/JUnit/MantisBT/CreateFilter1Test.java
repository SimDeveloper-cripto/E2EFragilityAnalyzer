...
public class CreateFilter1Test {
  ...
  public void createFilter1() throws InterruptedException {
    ...
    /* This Selector does not work
      - If I understand what the test does, my changes do the same thing.
      - Old Operation: driver.findElement(By.cssSelector(".btn:nth-child(9)")).click();
    **/

    driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div/div/div[2]/div/form[2]/input")).click();
    {
