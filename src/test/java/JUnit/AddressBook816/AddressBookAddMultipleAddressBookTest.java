...
public class AddressBookAddMultipleAddressBookTest {
	...
	public void addressBookAddMultipleAddressBook() throws Exception {
		...
		// FUNZIONANTE PER 8.0.0 8.1.0 8.1.6
		//driver.findElement(By.name("quickadd")).click();

		//FUNZIONANTE PER 8.1.7

		List<WebElement> quick_button = driver.findElements(By.name("quickadd"));
		quick_button.get(1).click();
		...
		// FUNZIONANTE 8.0.0 8.1.0 8.1.6
		driver.findElement(By.name("quickadd")).click();


		//FUNZIONANTE PER 8.1.7
		/*quick_button = driver.findElements(By.name("quickadd"));
		quick_button.get(1).click();
		*/
		driver.findElement(By.name("firstname")).clear();
		...
		*/
		...
		//CODICE FUNZIONANTE PER 8.0.0 e 8.1.0
		/*
		...
		*/
		...
		// CODICE FUNZIONANTE PER 8.1.6 e 8.1.7

		assertEquals("lastname1", driver.findElement(By.xpath(".//*[@id='maintable']/tbody/tr[2]/td[3]")).getText());
		assertEquals("firstname1", driver.findElement(By.xpath(".//*[@id='maintable']/tbody/tr[2]/td[4]")).getText());
		assertEquals("mail1@mail.it",
		...
		assertEquals("lastname2", driver.findElement(By.xpath(".//*[@id='maintable']/tbody/tr[3]/td[3]")).getText());
		assertEquals("firstname2", driver.findElement(By.xpath(".//*[@id='maintable']/tbody/tr[3]/td[4]")).getText());
		assertEquals("mail2@mail.it",
		...
		assertEquals("lastname3", driver.findElement(By.xpath(".//*[@id='maintable']/tbody/tr[4]/td[3]")).getText());
		assertEquals("firstname3", driver.findElement(By.xpath(".//*[@id='maintable']/tbody/tr[4]/td[4]")).getText());
		assertEquals("mail3@mail.it",
