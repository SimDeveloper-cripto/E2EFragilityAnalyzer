<?php
define("PHORMER_VERSION", "3.13");
define("PHORMER_BUILD_DATE", "30th Aug. 2006");
...
function thumbBox($pid, $a_info = "", $force = false, $isInAdmin = false, $targ="_blank") { ### :)
	...
	echo "\t\t\t<center>\n";
	echo "\t\t\t\t<a target=\"$targ\" href=\".?p=$pid\" title=\"$inTitName$hits hits, rated $rate by $raters person $a_info\">\n";
